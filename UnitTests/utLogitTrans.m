classdef utLogitTrans < utContinuous
    ...
    methods
        ...
        function testCase=utLogitTrans(varargin)  % Constructor
    ...
    methods (TestClassSetup, ParameterCombination='sequential')
        ...
        function ClassSetup(testCase,parmCase)
            ...
            switch parmCase
                case 1
                    testCase.Dist = LogitTrans(UniformCW(0.5,0.5));
                    %               testCase.SkipEstAll = true;
                case 2
                    testCase.Dist = LogitTrans(Beta(21,2));
                case 3
                    testCase.Dist = LogitTrans(UniformCW(0.75,0.2));
            end
