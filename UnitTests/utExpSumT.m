classdef utExpSumT < utContinuous
    ...
    properties (ClassSetupParameter)
        ...
        parmPrcutoff = struct( 'p_25',.25 , 'p_165',.165 , 'p_1',.1      , 'p_4',.4 , 'p_12',.12 );
    end
    ...
    methods
        ...
        function testCase=utExpSumT(varargin)  % Constructor
    ...
    methods (TestClassSetup, ParameterCombination='sequential')
        ...
        function ClassSetup(testCase,parmrate1,parmrate2,parmPrcutoff)
            % Computations specific to the ExpSumT distribution.
            temp = ExpSum(parmrate1,parmrate2);
            parmcutoff = temp.InverseCDF(1-parmPrcutoff);
            testCase.Dist = ExpSumT(parmrate1,parmrate2,parmcutoff);
