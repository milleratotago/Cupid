classdef utTruncatedXhi < utContinuous
    ...
    methods
        ...
        function testCase=utTruncatedXhi(varargin)  % Constructor
    ...
    methods (TestClassSetup, ParameterCombination='sequential')
        ...
        function ClassSetup(testCase,parmCase)
            ...
            switch parmCase
              case 1
                testCase.Dist = TruncatedXhi(Uniform(0,1),.8);
              ...
              case 2
                testCase.Dist = TruncatedXhi(Normal(0,1),1);
                testCase.EstParmCodes = 'rrf';
              case 3
                testCase.Dist = TruncatedXhi(Exponential(0.1),21);
