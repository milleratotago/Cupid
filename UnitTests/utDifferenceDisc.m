classdef utDifferenceDisc < utDiscrete;
    ...
    methods
        ...
        function testCase=utDifferenceDisc(varargin)  % Constructor
    ...
    methods (TestClassSetup, ParameterCombination='sequential')
        ...
        function ClassSetup(testCase,parmCase)
            ...
            switch parmCase
                case 1
                    testCase.Dist = Difference(Binomial(10,.5),Poisson(2.3));
                    testCase.EstParmCodes = 'frf';
                case 2
                    testCase.Dist = Difference(UniformInt(0,10),Geometric(.10));
                    testCase.EstParmCodes = 'ffr';
                case 3
                    testCase.Dist = Difference(Poisson(2.5),Poisson(3.2));
                    testCase.EstParmCodes = 'rf';  % Parameters trade off if both varied.
                case 4
                    testCase.Dist = Difference(Binomial(10,.5),Binomial(4,.9));
