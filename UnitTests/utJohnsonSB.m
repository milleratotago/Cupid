classdef utJohnsonSB < utContinuous
    ...
    methods
        ...
        function testCase=utJohnsonSB(varargin)  % Constructor
    ...
    methods (TestClassSetup, ParameterCombination='sequential')
        ...
        function ClassSetup(testCase,parm1Loc,parm2Scale,parm3Alpha1,parm4Alpha2)
            % Computations specific to the JohnsonSB distribution.
            testCase.Dist = JohnsonSB(parm1Loc,parm2Scale,parm3Alpha1,parm4Alpha2);
            ...
            testCase.SkipEstAll = true;  % Estimation is unsatisfactory.  Parameters often retrieved within 5%, but sometime much worse.
